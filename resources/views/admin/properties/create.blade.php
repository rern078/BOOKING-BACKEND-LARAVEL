<x-admin-layout :title="'New Property'">
    @include('admin.partials.flash')

    <div class="rounded-2xl border bg-white p-5 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                <div class="text-lg font-semibold">Create Property</div>
                <div class="text-sm text-slate-600">Add a new property.</div>
            </div>
        ...
        <form class="mt-6" method="POST" action="{{ route('admin.properties.store') }}" enctype="multipart/form-data">
            @csrf
