<x-admin-layout :title="'New Customer'">
    @include('admin.partials.flash')

    <div class="rounded-2xl border bg-white p-5 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                <div class="text-lg font-semibold">Create Customer</div>
                <div class="text-sm text-slate-600">Add a new customer.</div>
            </div>
        ...
        <form class="mt-6" method="POST" action="{{ route('admin.customers.store') }}">
            @csrf
