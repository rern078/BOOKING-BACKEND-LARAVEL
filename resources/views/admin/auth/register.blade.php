        ...
        <form class="px-6 pb-6 pt-6 space-y-4" method="POST" action="{{ route('admin.register.submit') }}">
            ...
            <div>
                ...
                <div x-data="{ show: false }" class="relative mt-1">
                    <input
                        class="w-full rounded-xl border border-slate-200 bg-white py-2 pl-3 pr-10 text-sm shadow-sm placeholder:text-slate-400 focus:border-indigo-400 focus:outline-none focus:ring-4 focus:ring-indigo-100"
                        id="password"
                        name="password"
            ...
            <button class="w-full rounded-xl bg-slate-500 px-4 py-2.5 text-sm font-semibold text-white hover:bg-slate-600" type="submit">
                Register
            </button>
        </form>
