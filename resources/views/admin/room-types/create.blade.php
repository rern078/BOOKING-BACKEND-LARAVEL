<x-admin-layout :title="'New Room Type'">
    @include('admin.partials.flash')

    <div class="rounded-2xl border bg-white p-5 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                <div class="text-lg font-semibold">Create Room Type</div>
                <div class="text-sm text-slate-600">Add a new room type.</div>
            </div>
        ...
        <form class="mt-6" method="POST" action="{{ route('admin.room-types.store') }}">
            @csrf
