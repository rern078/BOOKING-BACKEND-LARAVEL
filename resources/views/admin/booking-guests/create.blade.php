<x-admin-layout :title="'New Booking Guest'">
    @include('admin.partials.flash')

    <div class="rounded-2xl border bg-white p-5 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                <div class="text-lg font-semibold">Create Guest</div>
                <div class="text-sm text-slate-600">Add a guest to a booking.</div>
            </div>
        ...
        <form class="mt-6" method="POST" action="{{ route('admin.booking-guests.store') }}">
            @csrf
